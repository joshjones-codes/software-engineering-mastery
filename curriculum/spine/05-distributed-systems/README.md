...
| [Offline-First & Sync](11-offline-first-and-sync.md) | 🟡 should | ~2–3 wknds | sync queues, conflict resolution, CRDT intuition — mobile clients that must keep working with no signal |
