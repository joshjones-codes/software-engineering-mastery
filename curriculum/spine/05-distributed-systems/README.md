...
| [Offline-First & Sync](11-offline-first-and-sync.md) | 🟡 should | ~2–3 wknds | sync queues, conflict resolution, CRDT intuition — field crews and mobile users with no signal |
